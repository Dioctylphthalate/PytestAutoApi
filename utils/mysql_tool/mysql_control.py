...
if __name__ == '__main__':
    a = MysqlDB()
    b = a.query(sql="SELECT CONCAT('{\"fldGuid\":\"',fld_guid,'\",\"fldProjectName\":\"',fld_project_name,'\",\"fldOwnerDate\":\"',DATE_FORMAT(fld_owner_date,'\"%Y-%m\"'),'\",\"fldAmount\":\"',fld_amount,'\",\"fldLateFee\":\"',fld_late_fee,'\",\"fldRebate\":\"',fld_rebate,'\",\"fldLeftTotal\":\"',fld_left_total,'\",\"fldInvoicingStatus\":\"未开票\",\"fldDesc\":\"',fld_desc,'\",\"fldObjectName\":\"',fld_object_name,'\",\"fldOwnerName\":\"',fld_owner_name,'\",\"fldOwnerGuid\":\"',fld_owner_guid,'\",\"fldAllotDate\":\"',fld_allot_date,'\",\"fldResource\":\"',fld_resource,'\",\"fldIncome\":',fld_income,',\"fldOccurAmount\":\"0\",\"fldObjectType\":',fld_project_type,',\"fldObjectGuid\":\"',fld_object_guid,'\",\"fldProjectGuid\":\"',fld_project_guid,'\",\"fldLateDate\":\"',fld_late_date,'\",\"fldLateStop\":',fld_late_stop,',\"fldAreaGuid\":\"',fld_area_guid,'\",\"fldTotal\":\"',fld_total,'\",\"fldBusiGuid\":\"\",\"fldStartDate\":\"',fld_start_date,'\",\"fldEndDate\":\"',fld_end_date,'\",\"fldIncomeSource\":',fld_income_source,',\"fldBackGo\":0,\"fldMaxData\":\"0.00\",\"fldEndRead\":\"',fld_end_read,'\",\"fldStartRead\":\"',fld_start_read,'\",\"fldLagType\":null,\"fldLagFee\":null,\"fldFeeType\":null,\"fldMouthNum\":null,\"fldDayNum\":null,\"fldBeyond\":null,\"fldFictitiousFee\":\"0.00\",\"fldBusiGuidReal\":\"\"}') as sourceDataList FROM es_charge_owner_fee WHERE fld_area_guid = '8e9078f8-b4eb-11ee-af7e-00163e1c1703';")
    print(b)
